    ...
    if(stream == null) {
      ...
      locationSubscription=stream.listen((position) {
        ...
        nearbyStations.retainWhere((Station s) {
          ...
          if (dist <= range) { //Distance between two coordinates.
        ...
        if(detected){
          ...
          /*if(nextStation == null){
                        actualStation = nearbyStations.first;
                        int next = actualLine.Stations.indexWhere((entry s){
          ...
          if(DrivingDetector.DrivingScore >= 40) {
            var post = {
              ...
              'Timestamp': DateTime.now().add(
                  ServerClientDifference).toString().split(".")[0]
            };
            //print(post);
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        ...
        return AlertDialog(
          ...
          content: new Text("Did you finish your travel? Or did something happen?"),
          actions: <Widget>[
